                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <input type="radio" id="mc" name="payment" v-model="selectedPaymentOption"
                                value="Mastercard" />
                            <label for="mc"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                </svg> Mastercard</label> <br>
                            <input type="radio" id="pp" name="payment" v-model="selectedPaymentOption" value="Paypal" />
                            <label for="pp"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <label for="cash"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
