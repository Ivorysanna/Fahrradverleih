    ...
    <section id="rent-bike-now">
        ...
        <div class="loginForm">
            <div class="col-lg-3">
                ...
                <input class="btn btn-primary" type="button" ref="logInButton" id="logInButton" name="answer"
                    value="Log In" @click="logInDiv" />
            </div>
        ...
        <div class="paybg">
            <div class="col">
                <div class="card col text-center">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2 text-muted">Please choose your preferred payment option</h6> <br>
                        <form id="paymentForm">
                            <input type="radio" id="mc" name="payment" v-model="selectedPaymentOption"
                                value="Mastercard" />
                            <label class="payment" for="mc"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="currentColor" class="bi bi-credit-card-2-back"
                                    viewBox="0 0 16 16">
                                    <path
                                ...
                                Mastercard</label>
                            <br />
                            <input class="payment" type="radio" id="pp" name="payment" v-model="selectedPaymentOption"
                                value="Paypal" />
                            <label class="payment" for="pp"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                Paypal</label>
                            <br />
                            <input class="payment" type="radio" id="cash" name="payment" v-model="selectedPaymentOption"
                                value="Cash" />
                            <label class="payment" for="cash"><svg xmlns="http://www.w3.org/2000/svg" width="16"
...
.bgdiv {
    background-image: url("@/assets/pictures/bikes_nature.png");
}

.paybg {
    background-image: url("@/assets/pictures/bikkk.png");
}
